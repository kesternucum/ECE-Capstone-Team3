...
#
# Original: https://github.com/guptavasu1213/Yolo-Vehicle-Counter
#
# Author: Kester Nucum
#
# Date:         March 10, 2023
...
while True:
	...
	if (num_frame_read == 0):
		...
		# on only a certain section of the image
		# -> these dimensions must be determined
		# h,w = frame.shape[:2]
		...
		blob = cv2.dnn.blobFromImage(masked_frame, 1 / 255.0, (inputWidth, inputHeight),
