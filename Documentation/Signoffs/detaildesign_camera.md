...
<div align="left">
  ...
  * Height on Light Posts
    -After consulting with Facilities, the maximum height in which cameras can be installed is 20 ft (22 ft counting the cement block) for the sake of the cameras. To maximize the field of range that the cameras can see, all cameras except Camera 6b will need to be placed at a height of 22 ft.
...
2.  Monitoring of Parking Spaces and Entrances
  * Sectoring of Bell Hall Red Lot
    - The parking lot behind Bell Hall has 78 Red parking spots.
